    ...
    <div class="mx-2">
      ...
      <form  action="{{route('topics.store')}}" method="POST"  class="px-md-5" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="text" placeholder="e.g. Design Patterns" name="title" class="form-control py-2"value="{{old('title')}}" />
              @error('title')
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
             <input type="number" name="no_of_views" id="" rows="5" class="form-control" value={{old('no_of_views')}}>
                @error('no_of_views')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
          </div>
