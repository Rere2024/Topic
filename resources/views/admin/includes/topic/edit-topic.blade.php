    ...
    <div class="mx-2">
      ...
      enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
             <input type="number" name="no_of_views" id="" rows="5" class="form-control" value={{old('no_of_views', $topics->no_of_views)}}>
                @error('no_of_views')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="trending" value="1" @checked(old('trending', $topics->published)) />
          </div>
        </div>
        <div class="form-group mb-3 row">
          <label for="" class="form-label col-md-2 fw-bold text-md-end">Published:</label>
          <div class="col-md-10">
            <input type="checkbox" class="form-check-input" style="padding: 0.7rem;" name="published" value="1" @checked(old('published', $topics->published))  />
          </div>
        </div>
        <hr>
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            ...
            <img src="{{asset("adminassets/images/". $topics['image']) }}" alt="" style="width: 10rem;">
            @error('image')
          <div class="alert alert-warning">{{$message}}</div>
          @enderror
          </div>
